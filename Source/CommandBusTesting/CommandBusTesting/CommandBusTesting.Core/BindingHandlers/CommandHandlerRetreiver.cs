...
//------------------------------------------------------------------------------------------
// <copyright file="CommandHandlerRetreiver.cs" company="United Shore Financial Services LLC.">
...
namespace CommandBusTesting.Core.BindingHandlers
{
    public class CommandHandlerRetreiver : ICommandHandlerRetreiver
    {
        private readonly IKernel kernel;

        public CommandHandlerRetreiver(IKernel kernel)
        {
            this.kernel = kernel;
        }
